...
public class DoubleFormatUtilTest extends TestCase {
	...
	public void performanceCompare() {
		...
		System.out.println("Format duration: " + formatDuration
		...
		System.out.println("Fast Format duration: " + fastFormatDuration
				+ "ms to format " + 3 * nbTest + " doubles");
		...
		System.out.println("BigDecimal format duration: " + bgDuration
				+ "ms to format " + 3 * nbTest + " doubles");
		...
		System.out.println("DecimalFormat duration: " + dfDuration
				+ "ms to format " + 3 * nbTest + " doubles");
		...
		System.out.println("toString duration: " + toStringDuration
				+ "ms to format " + 3 * nbTest + " doubles");
	}
