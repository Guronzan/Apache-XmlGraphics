...
/* $Id: GlyphsTest.java 750418 2009-03-05 11:03:54Z vhennebert $ */
...
public class GlyphsTest extends TestCase {
    ...
    @Test
    public void testGetUnicodeSequenceForGlyphName() {
        String glyph;
        String unicodes;
        ...
        assertEquals("Must contain 2126 - OHM SIGN", unicodes.charAt(0),
                '\u2126');
        ...
        assertEquals("Expected 0631 - ARABIC LETTER REH at position 0",
                unicodes.charAt(0), '\u0631');
        assertEquals(
                "Expected FEF3 - ARABIC LETTER YEH INITAL FORM at position 1",
                unicodes.charAt(1), '\uFEF3');
        assertEquals(
                "Expected FE8E - ARABIC LETTER ALEF FINAL FORM at position 2",
                unicodes.charAt(2), '\uFE8E');
        ...
        unicodes = Glyphs.getUnicodeSequenceForGlyphName(glyph);
        assertEquals(4, unicodes.length());
        assertEquals("Must contain 013B", unicodes.charAt(0), '\u013B');
        assertEquals("Must contain 20AC", unicodes.charAt(1), '\u20AC');
        assertEquals("Must contain 0308", unicodes.charAt(2), '\u0308');
        assertEquals("Must contain 20AC", unicodes.charAt(3), '\u20AC');
    ...
    @Test
    public void testGetCharNameAlternativesFor() {
