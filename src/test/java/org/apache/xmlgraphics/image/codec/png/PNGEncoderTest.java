...
/* $Id: PNGEncoderTest.java 750418 2009-03-05 11:03:54Z vhennebert $ */
...
public class PNGEncoderTest extends TestCase {
    ...
    public void testPNGEncoding() throws IOException {
        ...
        try (final InputStream is = buildInputStream(bos)) {
            ...
            if (decodedRenderedImage instanceof BufferedImage) {
                ...
                decodedImage = new BufferedImage(
                        decodedRenderedImage.getWidth(),
