...
/* $Id: NamedColorTest.java 1051421 2010-12-21 08:54:25Z jeremias $ */
...
public class NamedColorTest extends TestCase {
    ...
    public void testNamedColorWithCIELab() {
        ...
        // CIE Lab definition of "Postgelb" (postal yellow) at D50 as defined by
        // Swiss Post
        // Convert to XYZ
        final float[] c1xyz = lab.toCIEXYZNative(83.25f, 16.45f, 96.89f);
        ...
        final NamedColorSpace ncs = new NamedColorSpace("Postgelb", c1xyz);
        final Color c1 = new Color(ncs, new float[] { 1.0f }, 1.0f);

        assertEquals(ncs, c1.getColorSpace());
        final float[] comp = c1.getColorComponents(null);
        ...
        // NOTE: Allowing for some fuzziness due to differences in XYZ->sRGB
        // calculation between
        // Java 1.5 and 6.
    ...
    public void testEquals() {
        NamedColorSpace ncs1 = new NamedColorSpace("Postgelb", new float[] {
                POSTGELB_X, POSTGELB_Y, POSTGELB_Z });

        NamedColorSpace ncs2 = new NamedColorSpace("Postgelb", new float[] {
                POSTGELB_X, POSTGELB_Y, POSTGELB_Z });
        ...
        final float[] xyz = lab.toCIEXYZ(postgelbLab.getColorComponents(null));
        xyz[0] = POSTGELB_X;
        xyz[1] = POSTGELB_Y;
        xyz[2] = POSTGELB_Z;
