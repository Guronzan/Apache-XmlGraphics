...
public class EPSDocumentGraphics2D extends AbstractPSDocumentGraphics2D {
    ...
    protected void writeFileHeader() throws IOException {
        final Long pagewidth = Long.valueOf(this.width);
        final Long pageheight = Long.valueOf(this.height);
    ...
    protected void writePageHeader() throws IOException {
        final Integer pageNumber = this.pagecount;
