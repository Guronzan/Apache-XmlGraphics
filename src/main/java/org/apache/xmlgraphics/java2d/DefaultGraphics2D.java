...
/**
 * This concrete implementation of <tt>AbstractGraphics2D</tt> is a simple help
 * to programmers to get started with their own implementation of
 * <tt>Graphics2D</tt>. <tt>DefaultGraphics2D</tt> implements all the abstract
 * methods is <tt>AbstractGraphics2D</tt> and makes it easy to start
...
public class DefaultGraphics2D extends AbstractGraphics2D {
    ...
    public void drawString(final AttributedCharacterIterator iterator,
        ...
        log.error("drawString(AttributedCharacterIterator)");
    }
    ...
    public GraphicsConfiguration getDeviceConfiguration() {
        log.info("getDeviceConviguration");
        return null;
    }
