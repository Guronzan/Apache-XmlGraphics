...
public class GraphicContext implements Cloneable {
    ...
    public Shape getClip() {
        try {
            ...
            log.error("NoninvertibleTransformException", e);
            return null;
        }
    }
     ...
     * @see RenderingHints
     */
    public void setRenderingHints(final Map<Key, ?> hints) {
     ...
     * @see RenderingHints
     */
    public void addRenderingHints(final Map<Key, ?> hints) {
     ...
     */
    public void clip(final Shape inShape) {
        final Shape s;
        if (inShape != null) {
            s = this.transform.createTransformedShape(inShape);
        } else {
            throw new NullPointerException("inShade is null");
        }
