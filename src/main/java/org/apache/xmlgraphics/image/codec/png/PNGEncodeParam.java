...
public abstract class PNGEncodeParam implements ImageEncodeParam {
    ...
    public static class Palette extends PNGEncodeParam {
         ...
         *
         */
        private static final long serialVersionUID = 4588070212455604887L;
        ...
        public void setBitDepth(final int bitDepth) {
            if (bitDepth != 1 && bitDepth != 2 && bitDepth != 4
                ...
                throw new IllegalArgumentException(
                        PropertyUtil.getString("PNGEncodeParam2"));
            }
        ...
        public void setPalette(final int[] rgb) {
            if (rgb.length < 1 * 3 || rgb.length > 256 * 3) {
                throw new IllegalArgumentException(
                        PropertyUtil.getString("PNGEncodeParam0"));
            }
            if (rgb.length % 3 != 0) {
                throw new IllegalArgumentException(
                        PropertyUtil.getString("PNGEncodeParam1"));
            }
        ...
        public int[] getPalette() {
            if (!this.paletteSet) {
                throw new IllegalStateException(
                        PropertyUtil.getString("PNGEncodeParam3"));
            }
        ...
        public int getBackgroundPaletteIndex() {
            if (!this.backgroundSet) {
                throw new IllegalStateException(
                        PropertyUtil.getString("PNGEncodeParam4"));
            }
    ...
    public static class Gray extends PNGEncodeParam {
         ...
         *
         */
        private static final long serialVersionUID = -8965493424720468613L;
        ...
        public int getBackgroundGray() {
            if (!this.backgroundSet) {
                throw new IllegalStateException(
                        PropertyUtil.getString("PNGEncodeParam6"));
            }
        ...
        public int getTransparentGray() {
            if (!this.transparencySet) {
                throw new IllegalStateException(
                        PropertyUtil.getString("PNGEncodeParam7"));
            }
        ...
        public void setBitShift(final int bitShift) {
            if (bitShift < 0) {
                throw new IllegalArgumentException(
                        PropertyUtil.getString("PNGEncodeParam25"));
            }
        ...
        public int getBitShift() {
            if (!this.bitShiftSet) {
                throw new IllegalStateException(
                        PropertyUtil.getString("PNGEncodeParam8"));
            }
    ...
    public static class RGB extends PNGEncodeParam {
         ...
         *
         */
        private static final long serialVersionUID = -6462084532227317991L;
        ...
        public void setBitDepth(final int bitDepth) {
            if (bitDepth != 8 && bitDepth != 16) {
                throw new IllegalArgumentException(
                        PropertyUtil.getString("PNGEncodeParam26"));
            }
            this.bitDepth = bitDepth;
            this.bitDepthSet = true;
        }
        ...
        public void setBackgroundRGB(final int[] rgb) {
            if (rgb.length != 3) {
                throw new IllegalArgumentException(
                        PropertyUtil.getString("PNGEncodeParam27"));
            }
        ...
        public int[] getBackgroundRGB() {
            if (!this.backgroundSet) {
                throw new IllegalStateException(
                        PropertyUtil.getString("PNGEncodeParam9"));
            }
        ...
        public int[] getTransparentRGB() {
            if (!this.transparencySet) {
                throw new IllegalStateException(
                        PropertyUtil.getString("PNGEncodeParam10"));
            }
     ...
     */
    public abstract void setBitDepth(final int bitDepth);
    ...
    public int getBitDepth() {
        if (!this.bitDepthSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam11"));
        }
    ...
    public void setChromaticity(final float[] chromaticity) {
        if (chromaticity.length != 8) {
            throw new IllegalArgumentException(
                    PropertyUtil.getString("PNGEncodeParam28"));
        }
     ...
     */
    public void setChromaticity(final float whitePointX,
            final float whitePointY, final float redX, final float redY,
            final float greenX, final float greenY, final float blueX,
            final float blueY) {
    ...
    public float[] getChromaticity() {
        if (!this.chromaticitySet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam12"));
        }
    ...
    public float getGamma() {
        if (!this.gammaSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam13"));
        }
        return this.gamma;
    }
    ...
    public int[] getPaletteHistogram() {
        if (!this.paletteHistogramSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam14"));
        }
    ...
    public byte[] getICCProfileData() {
        if (!this.ICCProfileDataSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam15"));
        }
    ...
    public void setPhysicalDimension(final int xPixelsPerUnit,
            final int yPixelsPerUnit, final int unitSpecifier) {
    ...
    public int[] getPhysicalDimension() {
        if (!this.physicalDimensionSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam16"));
        }
    ...
    public PNGSuggestedPaletteEntry[] getSuggestedPalette() {
        if (!this.suggestedPaletteSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam17"));
        }
    ...
    public int[] getSignificantBits() {
        if (!this.significantBitsSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam18"));
        }
    ...
    public int getSRGBIntent() {
        if (!this.SRGBIntentSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam19"));
        }
    ...
    public String[] getText() {
        if (!this.textSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam20"));
        }
        return this.text;
    }
    ...
    public Date getModificationTime() {
        if (!this.modificationTimeSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam21"));
        }
    ...
    public String[] getCompressedText() {
        if (!this.zTextSet) {
            throw new IllegalStateException(
                    PropertyUtil.getString("PNGEncodeParam22"));
        }
        return this.zText;
    }
     ...
     */
    public synchronized void addPrivateChunk(final String type,
            final byte[] data) {
     ...
     */
    public int filterRow(final byte[] currRow, final byte[] prevRow,
            final byte[][] scratchRows, final int bytesPerRow,
