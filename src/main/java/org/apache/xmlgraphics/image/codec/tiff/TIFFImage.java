...
public class TIFFImage extends AbstractRed {
    ...
    private void inflate(final byte[] deflated, final byte[] inflated) {
        ...
        try {
            ...
            log.error("DataFormatException", dfe);
     ...
     */
    public TIFFImage(final SeekableStream stream,
            final TIFFDecodeParam inParam, final int directory)
                    throws IOException {

        this.stream = stream;
        final TIFFDecodeParam param;
        if (inParam == null) {
