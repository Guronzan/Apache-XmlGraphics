...
public abstract class SeekableStream extends InputStream implements DataInput {
     ...
     */
    public static SeekableStream wrapInputStream(final InputStream is,
     ...
     */
    @Override
    public abstract int read(final byte[] b, final int off, final int len)
            throws IOException;
    ...
    private final byte[] ruileBuf = new byte[4];
    ...
    public final long readUnsignedIntLE() throws IOException {
        ...
        final long ch1 = this.ruileBuf[0] & 0xff;
        final long ch2 = this.ruileBuf[1] & 0xff;
        final long ch3 = this.ruileBuf[2] & 0xff;
        final long ch4 = this.ruileBuf[3] & 0xff;
