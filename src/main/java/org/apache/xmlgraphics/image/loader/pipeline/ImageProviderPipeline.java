...
public class ImageProviderPipeline {
     ...
     */
    public Image execute(final ImageInfo info, final Map<Object, Object> hints,
    ...
    public Image execute(final ImageInfo info, final Image originalImage,
            final Map<Object, Object> inHints, final ImageSessionContext context)
        ...
        if (img == null && this.loader != null) {
            ...
            if (log.isTraceEnabled()) {
                ...
                log.trace("Image loading using {} took {} ms.", this.loader,
                        duration);
            }
        ...
        if (converterCount > 0) {
            for (int i = startingPoint; i < converterCount; ++i) {
                ...
                if (log.isTraceEnabled()) {
                    duration = System.currentTimeMillis() - start;
                    log.trace("Image conversion using {} took {} ms.",
                            converter, duration);
                }
    ...
    public Penalty getConversionPenalty(final ImageImplRegistry registry) {
        ...
        for (final ImageConverter converter : this.converters) {
