...
public class ImageLoaderImageIO extends AbstractImageLoader {
    ...
    private static final Set<Object> providersIgnoringICC = new HashSet<>(); // CSOK:
            ...
            while (iter.hasNext()) {
                ...
                try {
                    ...
                    try {
                        ...
                        log.error("IndexOutOfBoundsException", indexe);
