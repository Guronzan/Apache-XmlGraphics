...
public interface ImageSessionContext {
     ...
     * @throws IOException
     */
    Source newSource(final String uri) throws IOException;
     ...
     * @throws IOException
     */
    Source needSource(final String uri) throws IOException;
     ...
     * @throws IOException
     */
    void returnSource(final String uri, final Source src) throws IOException;
