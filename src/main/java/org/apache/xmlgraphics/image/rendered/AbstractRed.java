...
public abstract class AbstractRed implements CachableRed {
     ...
     */
    protected AbstractRed(final Rectangle bounds,
     ...
     */
    protected AbstractRed(final CachableRed src, final Map<String, Object> props) {
     ...
     */
    protected AbstractRed(final CachableRed src, final Rectangle bounds,
            final ColorModel cm, final SampleModel sm,
            final Map<String, Object> props) {
    ...
    protected void init(final CachableRed src, final Rectangle inBounds,
        ...
        if (sm == null) {
            sm = cm.createCompatibleSampleModel(this.bounds.width,
                    this.bounds.height);
        }
        this.sm = sm;
     ...
     *            this initializes the props Map.
     */
    protected AbstractRed(final List<RenderedImage> srcs,
            final Rectangle bounds, final Map<String, Object> props) {
     ...
     */
    protected AbstractRed(final List<RenderedImage> srcs,
            final Rectangle bounds, final ColorModel cm, final SampleModel sm,
            final Map<String, Object> props) {
    ...
    protected AbstractRed(final List<RenderedImage> srcs,
            final Rectangle bounds, final ColorModel cm, final SampleModel sm,
            final int tileGridXOff, final int tileGridYOff,
            final Map<String, Object> props) {
    ...
    public Object getProperty(final String name) {
        ...
        final Iterator<RenderedImage> i = this.srcs.iterator();
        while (i.hasNext()) {
            final RenderedImage ri = i.next();
    ...
    public String[] getPropertyNames() {
        final Set<String> keys = this.props.keySet();
        String[] ret = new String[keys.size()];
        keys.toArray(ret);

        final Iterator<RenderedImage> iter = this.srcs.iterator();
        while (iter.hasNext()) {
            final RenderedImage ri = iter.next();
