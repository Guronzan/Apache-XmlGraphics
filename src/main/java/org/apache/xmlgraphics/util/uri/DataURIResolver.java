...
public class DataURIResolver implements URIResolver {
    ...
    public Source resolve(final String href, final String base)
        ...
        if (href.startsWith("data:")) {
            try {
                ...
                log.error("Error while resolving URI", e);
                return null;
            }
        } else {
            return null;
     ...
     * @see <a href="http://www.ietf.org/rfc/rfc2397">RFC 2397</a>
     */
    private Source parseDataURI(final String href) throws IOException {
        ...
        if (header.endsWith(";base64")) {
            ...
            try (final ByteArrayInputStream encodedStream = new ByteArrayInputStream(
                    bytes)) {
                try (final Base64DecodeStream decodedStream = new Base64DecodeStream(
                        encodedStream)) {
