...
public class EventRecorder implements DSCHandler {
    ...
    private final List<PSObject> events = new ArrayList<>();
    ...
    public void replay(final DSCHandler handler) throws IOException {
        for (final PSObject obj : this.events) {
    ...
    private static class PSComment implements PSObject {
    ...
    private static class PSLine implements PSObject {
