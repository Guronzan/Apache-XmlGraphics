...
public final class PSProcSets {
    ...
    private static class StdProcSet extends PSProcSet implements PSCommandMap {
        ...
        public void writeTo(final PSGenerator gen) throws IOException {
            ...
            for (final Entry<String, String> entry : STANDARD_MACROS.entrySet()) {
        ...
        public String mapCommand(final String command) {
            final String mapped = STANDARD_MACROS.get(command);
     ...
     */
    @Deprecated
    public static void writeFOPStdProcSet(final PSGenerator gen)
            throws IOException {
        writeStdProcSet(gen);
    }
     ...
     */
    @Deprecated
    public static void writeFOPEPSProcSet(final PSGenerator gen)
            throws IOException {
        writeEPSProcSet(gen);
    }
