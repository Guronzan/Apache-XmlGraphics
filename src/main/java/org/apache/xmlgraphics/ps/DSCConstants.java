...
public final class DSCConstants {
     ...
     * needed or supplied on the present page.
     */
    ...
    /**
     * Indicator for the PostScript interpreter that the value is provided later
     * in the document (mostly in the %%Trailer section).
     */
