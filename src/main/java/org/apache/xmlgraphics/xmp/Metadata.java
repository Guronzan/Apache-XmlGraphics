...
public class Metadata implements XMLizable, PropertyAccess {
    ...
    private final Map<QName, XMPProperty> properties = new HashMap<>();
    ...
    public XMPProperty getProperty(final QName name) {
        final XMPProperty prop = this.properties.get(name);
        return prop;
    }
    ...
    public void mergeInto(final Metadata target) {
        ...
        for (final XMPProperty prop : this.properties.values()) {
    ...
    public void toSAX(final ContentHandler handler) throws SAXException {
        ...
        for (final QName n : this.properties.keySet()) {
