...
public class XMPHandler extends DefaultHandler {
    ...
    private final Deque<Object> attributesStack = new LinkedList<>();
    private final Deque<Object> nestingInfoStack = new LinkedList<>();
    private final Deque<Object> contextStack = new LinkedList<>();
