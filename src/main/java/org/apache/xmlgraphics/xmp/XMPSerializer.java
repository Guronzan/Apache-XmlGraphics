...
public final class XMPSerializer {
     ...
     *            the metadata
     * @param res
     *            the JAXP Result to write to
     * @throws TransformerConfigurationException
     *             if an error occurs setting up the XML infrastructure.
     * @throws SAXException
     *             if a SAX-related problem occurs while writing the XML
     */
    public static void writeXML(final Metadata meta, final Result res)
            throws TransformerConfigurationException, SAXException {
        writeXML(meta, res, false, false);
    }

    /**
     * Writes the in-memory representation of the XMP metadata to an
     * OutputStream as an XMP packet.
     * 
     * @param meta
     *            the metadata
     * @param out
     ...
     * @param readOnlyXMP
     *            true if the generated XMP packet should be read-only
     * @throws TransformerConfigurationException
     *             if an error occurs setting up the XML infrastructure.
     * @throws SAXException
     *             if a SAX-related problem occurs while writing the XML
     */
    public static void writeXMPPacket(final Metadata meta,
            final OutputStream out, final boolean readOnlyXMP)
            throws TransformerConfigurationException, SAXException {
    ...
    private static void writeXML(final Metadata meta, final Result res,
            final boolean asXMPPacket, final boolean readOnlyXMP)
            throws TransformerConfigurationException, SAXException {
        ...
        try {
            ...
            // INDENT key is not supported by implementation. That's not tragic,
            // so just ignore.
        }
