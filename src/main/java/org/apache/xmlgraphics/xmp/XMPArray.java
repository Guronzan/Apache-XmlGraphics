...
public class XMPArray extends XMPComplexValue {
    ...
    private final List<String> xmllang = new ArrayList<>();
     ...
     */
    public String removeLangValue(final String inLang) {
        final String lang;
        if (inLang == null || "".equals(inLang)) {
